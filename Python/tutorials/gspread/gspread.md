...
**gspread** offers a simple interface between Python and Googl Spreadsheets' API.  
<br>
## Installation
<br>
...
- [Source as RMarkdown](https://github.com/rweyant/bertplot/blob/master/python/tutorials/gspread/gspread.Rmd)
